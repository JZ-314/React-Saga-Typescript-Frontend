...
export default function Settings() {
  ...
  const handleUploadImage = (type: any) => async (e: any) => {
    try {
  ...
  const handleClickDone = async () => {
    ...
    console.log(payload);
    await dispatch(updateUserRequest(currentUser.id, payload));
    ...
    <UserLayout>
      <div className="setting-page">
        <div className="user-profile-wrapper">
          <div className="user-profile-bg-wrapper">
            {userBgImage && <img src={userBgImage} className="user-profile-bg" alt="" />}
          </div>
