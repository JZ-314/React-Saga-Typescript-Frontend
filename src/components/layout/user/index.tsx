...
const UserLayout = ({ children, onChangeFullScreen }: UserLayoutProps) => {
  ...
  return (
    <div className="user_layout">
      <UserHeader onChangeFullScreen={onChangeFullScreen} />
      <div className="user_layout__container">{children}</div>
      <Modal />
    </div>
  );
};
